...
enum M5Joystick{
  Joystick_None = 0, Joystick_Analog, Joystick_Acc, Joystick_I2C
};

extern enum M5Joystick g_Joystick;
extern int g_JoystickXmin;
extern int g_JoystickXmax;
extern int g_JoystickYmin;
extern int g_JoystickYmax;
#endif /* m5stack */
